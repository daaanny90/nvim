...
-- Open in browser the repository of a npm package
vim.keymap.set("n", "<leader>gr", ":lua OpenNpmRepo()<CR>", { desc = "[G]o to npm [R]epo" })

function OpenNpmRepo()
  local word = vim.fn.expand("<cword>")
  vim.cmd("!npm repo " .. word)
end
